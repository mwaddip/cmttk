...
export declare function posixToSlot(posixMs: number, network: CardanoNetwork): number;
/** Convert an absolute slot number to POSIX milliseconds. */
export declare function slotToPosix(slot: number, network: CardanoNetwork): number;
